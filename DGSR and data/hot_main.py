...
if __name__ == "__main__":
    ...
    mashup_train_file = "recommend_mashup_api_id_train%_0.1.txt"
    mashup_test_file = "recommend_mashup_api_id_test%_0.1.txt"
    ...
    schedule = StepLR(optimizer, step_size=1000, gamma=0.5)
    ...
    for i in range(args.epoch):
        ...
        if i != 0 and i % 20 == 0:
            ...
            t3 = time.time()
            print("test metric:")
            average_hrk, average_ndcg = model_test.test_for_test(model, m_id, a_id, test_m_a_id, train_m_a_id, args)
